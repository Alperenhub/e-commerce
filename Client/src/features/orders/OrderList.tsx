                    ...
                    {orders?.map((order)=>(
                        <TableRow key={order.id}>
                            ...
                            <TableCell component="th" scope="row" sx={{width: 100}}>
                                <Button onClick={()=> handleDialogOpen(order)} size="small" variant="contained" endIcon={<ArrowRight/>}>
                                    Details
                                </Button>
                            </TableCell>
                        </TableRow>
                                ...
                                <TableBody>
                                    {selectedOrder?.orderItems.map((item)=>(
                                        <TableRow key={item.id}>
                                            <TableCell>
                                              <img src={`http://localhost:5173/images/${item.productImage}`} style={{height:60}}/>
                                            </TableCell>
