...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Alpy Kilinc", UserName = "Alpy", Email = "alpy@gmail.com" };
            var admin = new AppUser { Name = "Sercan Mert", UserName = "Seco", Email = "sercan@gmail.com" };
